 ...
 */
package com.bitadventurer.api.resources.user.requests;
...
@JsonDeserialize(builder = LoginUserRequest.Builder.class)
public final class LoginUserRequest {
    ...
    /**
     * @return The password for login in clear text
     */
